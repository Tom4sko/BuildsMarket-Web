      ...
      <section className="leadership-section">
        <Container>
          <div className="leadership-wrapper text-center">
            <h2>Administrator</h2>
            <p className="paragraph text-center mt-3 mt-lg-5 paragraph-color">Leadership is responsible for the entire BuildsMarket project. They accept or reject applications for
      ...
      <section className="builders-section">
        <Container>
          <div className="builders-wrapper text-center">
              <h2 className="mt-4 mt-lg-4">Builders</h2>
              <p className="paragraph text-center mt-3 mt-lg-5 paragraph-color">Builders are the people who create Minecraft content for BuildsMarket, such as
      ...
      <section className="graphics-section">
        <Container>
          <div className="graphics-wrapper text-center">
              <h2 className="mt-4 mt-lg-4">Graphics</h2>
              <p className="paragraph text-center mt-3 mt-lg-5 paragraph-color">Graphic designers are the people who take care of the design part
      ...
      <section className="render-section">
        <Container>
          <div className="render-wrapper text-center">
              <h2 className="mt-4 mt-lg-4">Render Artists</h2>
              <p className="paragraph text-center mt-3 mt-lg-5 paragraph-color">Render artists are the people who create amazing and creative renderings
      ...
      <section className="partners-section">
        <Container>
          <div className="partners-wrapper text-center">
              <h2 className="mt-4 mt-lg-4">Partners</h2>
              <p className="paragraph text-center mt-3 mt-lg-5 paragraph-color">In this section are our partners, these are people who help the project
